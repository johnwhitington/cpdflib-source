...
char *
cpdf_enumeratePDFsInfo (int key)
{
  CAMLparam0 ();
...
int
cpdf_parsePagespec (int pdf, char *str)
{
  CAMLparam0 ();
...
int
cpdf_validatePagespec (char *str)
{
  CAMLparam0 ();
...
char *
cpdf_stringOfPagespec (int pdf, int range)
{
  CAMLparam0 ();
...
int
cpdf_pagesFast (char *password, char *filename)
{
  CAMLparam0 ();
...
void
cpdf_toFile (int pdf, char *filename, int linearize, int make_id)
{
  CAMLparam0 ();
  CAMLlocal2 (fn, unit);
  CAMLlocalN (args, 4);
...
void *
cpdf_toMemory (int pdf, int linearize, int make_id, int *retlen)
{
  CAMLparam0 ();
...
void
cpdf_decryptPdf (int pdf, char *password)
{
  CAMLparam0 ();
...
void
cpdf_decryptPdfOwner (int pdf, char *password)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, fn, pdf_v, password_v);
...
void cpdf_toFileEncrypted
  (int pdf,
   ...
   int *ps,
   int len,
   char *owner, char *user, int linearize, int makeid, char *filename)
{
  CAMLparam0 ();
...
void cpdf_toFileEncryptedExt
  (int pdf,
   ...
   int makeid,
   int preserve_objstm,
   int generate_objstm, int compress_objstm, char *filename)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, fn, temp, permissions);
  CAMLlocalN (args, 11);
...
int
cpdf_mergeSimple (int *pdfs, int len)
{
  CAMLparam0 ();
...
int
cpdf_selectPages (int pdf, int range)
{
  CAMLparam0 ();
...
void
cpdf_scalePages (int pdf, int range, double sx, double sy)
{
  CAMLparam0 ();
  CAMLlocal2 (fn, unit);
  CAMLlocalN (args, 4);
...
void
cpdf_shiftContents (int pdf, int range, double dx, double dy)
{
  CAMLparam0 ();
  CAMLlocalN (args, 4);
  CAMLlocal2 (fn, unit);
...
void
cpdf_rotate (int pdf, int range, int angle)
{
  CAMLparam0 ();
...
void
cpdf_rotateBy (int pdf, int range, int angle)
{
  CAMLparam0 ();
  CAMLlocal5 (unit, fn, pdf_v, range_v, angle_v);
...
void
cpdf_rotateContents (int pdf, int range, double angle)
{
  CAMLparam0 ();
  CAMLlocal5 (unit, fn, pdf_v, range_v, angle_v);
...
void
cpdf_upright (int pdf, int range)
{
  CAMLparam0 ();
...
void
cpdf_crop (int pdf, int range, double x, double y, double w, double h)
{
  CAMLparam0 ();
  CAMLlocalN (args, 6);
  CAMLlocal2 (unit, fn);
...
void
cpdf_removeCrop (int pdf, int range)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, fn, pdf_v, range_v);
...
void
cpdf_removeTrim (int pdf, int range)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, fn, pdf_v, range_v);
...
void
cpdf_removeArt (int pdf, int range)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, fn, pdf_v, range_v);
...
void
cpdf_removeBleed (int pdf, int range)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, fn, pdf_v, range_v);
...
/* CHAPTER 6. Bookmarks */
void
cpdf_startGetBookmarkInfo (int pdf)
{
  CAMLparam0 ();
  CAMLlocal3 (fn_v, pdf_v, out_v);
...
int
cpdf_getBookmarkLevel (int serial)
{
  CAMLparam0 ();
...
int
cpdf_getBookmarkPage (int pdf, int serial)
{
  CAMLparam0 ();
...
void
cpdf_stampOn (int pdf, int pdf2, int range)
{
  CAMLparam0 ();
...
void
cpdf_stampUnder (int pdf, int pdf2, int range)
{
  CAMLparam0 ();
...
void cpdf_addText
  (int metrics,
   ...
   int midline,
   int topline, char *filename, double linewidth, int embed_fonts)
{
  CAMLparam0 ();
  CAMLlocal2 (fn, unit);
  CAMLlocalN (args, 24);
...
char *
cpdf_addTextReturnText (int serial)
{
  CAMLparam0 ();
  CAMLlocal3 (fn, serial_v, out_v);
...
double
cpdf_addTextReturnX (int serial)
{
  CAMLparam0 ();
  CAMLlocal3 (fn, serial_v, out_v);
...
double
cpdf_addTextReturnY (int serial)
{
  CAMLparam0 ();
  CAMLlocal3 (fn, serial_v, out_v);
...
double
cpdf_addTextReturnRotation (int serial)
{
  CAMLparam0 ();
  CAMLlocal3 (fn, serial_v, out_v);
...
double
cpdf_addTextReturnBaselineAdjustment (void)
{
  CAMLparam0 ();
  CAMLlocal2 (fn, out_v);
...
void
cpdf_removeText (int pdf, int range)
{
  CAMLparam0 ();
...
int
cpdf_textWidth (int font, char *text)
{
  CAMLparam0 ();
  CAMLlocal2 (fn, out_v);
...
void
cpdf_padAfter (int pdf, int range)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, pdf_v, range_v, fn);
...
char *
cpdf_getFontEncoding (int serial)
{
  CAMLparam0 ();
  CAMLlocal3 (serial_v, fn_v, out_v);
...
char *
cpdf_getModificationDate (int pdf)
{
  CAMLparam0 ();
  CAMLlocal3 (fn, pdf_v, out);
...
void cpdf_getDateComponents
  (char *date,
   ...
   int *month,
   int *day,
   int *hour, int *minute, int *second, int *hour_offset, int *minute_offset)
{
  CAMLparam0 ();
...
int
cpdf_hasBox (int pdf, int pagenumber, char *boxname)
{
  CAMLparam0 ();
...
void
cpdf_setTitle (int pdf, char *str)
{
  CAMLparam0 ();
...
void
cpdf_setAuthor (int pdf, char *str)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, fn, pdf_v, str_v);
...
void
cpdf_setSubject (int pdf, char *str)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, fn, pdf_v, str_v);
...
void
cpdf_setKeywords (int pdf, char *str)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, fn, pdf_v, str_v);
...
void
cpdf_setCreator (int pdf, char *str)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, fn, pdf_v, str_v);
...
void
cpdf_setProducer (int pdf, char *str)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, fn, pdf_v, str_v);
...
void
cpdf_setCreationDate (int pdf, char *str)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, fn, pdf_v, str_v);
...
void
cpdf_setModificationDate (int pdf, char *str)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, fn, pdf_v, str_v);
...
void
cpdf_setPageLayout (int pdf, enum cpdf_layout layout)
{
  CAMLparam0 ();
...
void
cpdf_setPageMode (int pdf, enum cpdf_pageMode mode)
{
  CAMLparam0 ();
...
void
cpdf_hideToolbar (int pdf, int flag)
{
  CAMLparam0 ();
...
void
cpdf_hideMenubar (int pdf, int flag)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, pdf_v, flag_v, fn);
...
void
cpdf_hideWindowUi (int pdf, int flag)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, pdf_v, flag_v, fn);
...
void
cpdf_fitWindow (int pdf, int flag)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, pdf_v, flag_v, fn);
...
void
cpdf_centerWindow (int pdf, int flag)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, pdf_v, flag_v, fn);
...
void
cpdf_displayDocTitle (int pdf, int flag)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, pdf_v, flag_v, fn);
...
void
cpdf_setMetadataFromByteArray (int pdf, void *data, int len)
{
  CAMLparam0 ();
...
void *
cpdf_getMetadata (int pdf, int *retlen)
{
  CAMLparam0 ();
...
void
cpdf_attachFile (char *filename, int pdf)
{
  CAMLparam0 ();
...
void
cpdf_attachFileFromMemory (void *data, int length, char *filename, int pdf)
{
  CAMLparam0 ();
...
void
cpdf_attachFileToPage (char *filename, int pdf, int pagenumber)
{
  CAMLparam0 ();
...
void
cpdf_removeAttachedFiles (int pdf)
{
  CAMLparam0 ();
...
void
cpdf_startGetAttachments (int pdf)
{
  CAMLparam0 ();
...
int
cpdf_numberGetAttachments (void)
{
  CAMLparam0 ();
...
char *
cpdf_getAttachmentName (int serial)
{
  CAMLparam0 ();
  CAMLlocal3 (fn, serial_v, out_v);
...
int
cpdf_getAttachmentPage (int serial)
{
  CAMLparam0 ();
  CAMLlocal3 (fn, serial_v, out_v);
...
void *
cpdf_getAttachmentData (int serial, int *retlen)
{
  CAMLparam0 ();
  ...
  memory = calloc (size, sizeof (char));
  if (memory == NULL && size > 0)
    printf ("getAttachmentData: failed");
  if (size > 0)
    {
      int x;
      char *indata = Data_bigarray_val (bytestream);
...
void
cpdf_blackText (int pdf, int range)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, fn, pdf_v, range_v);
...
void
cpdf_blackLines (int pdf, int range)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, fn, pdf_v, range_v);
...
void
cpdf_blackFills (int pdf, int range)
{
  CAMLparam0 ();
  CAMLlocal4 (unit, fn, pdf_v, range_v);
...
void
cpdf_thinLines (int pdf, int range, double minwidth)
{
  CAMLparam0 ();
...
void
cpdf_addContent (char *s, int before, int range, int pdf)
{
  CAMLparam0 ();
  CAMLlocal2 (fn, out);
  CAMLlocalN (args, 4);
...
void
cpdf_OCGRename (int pdf, char *f, char *t)
{
  CAMLparam0 ();
...
char *
cpdf_stampAsXObject (int pdf, int range, int stamp_pdf)
{
  CAMLparam0 ();
