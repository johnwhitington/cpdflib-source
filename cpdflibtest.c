...
int main(int argc, char **argv) {
  ...
  cpdf_toFileEncrypted(f3, encmethod, &permissions, 1, "owner", "user", false,
                       false, "testoutputs/encrypted.pdf");
  prerr();
  ...
  prerr();
  cpdf_toFile(pagespdf1, "testoutputs/scalepages.pdf", false, false);
  printf("---cpdf_scaleToFit()\n");
  cpdf_scaleToFit(pagespdf2, r3, 1.5, 1.8, 0.9);
  prerr();
  cpdf_toFile(pagespdf2, "testoutputs/scaletofit.pdf", false, false);
  printf("---cpdf_scaleToFitPaper()\n");
  cpdf_scaleToFitPaper(pagespdf3, r3, cpdf_a4portrait, 0.8);
  prerr();
  cpdf_toFile(pagespdf3, "testoutputs/scaletofitpaper.pdf", false, false);
  ...
  prerr();
  cpdf_toFile(pagespdf4, "testoutputs/scalecontents.pdf", false, false);
  printf("---cpdf_shiftContents()\n");
  cpdf_shiftContents(pagespdf5, r3, 1.5, 1.25);
  prerr();
  cpdf_toFile(pagespdf5, "testoutputs/shiftcontents.pdf", false, false);
  printf("---cpdf_rotate()\n");
  cpdf_rotate(pagespdf6, r3, 90);
  prerr();
  cpdf_toFile(pagespdf6, "testoutputs/rotate.pdf", false, false);
  printf("---cpdf_rotateBy()\n");
  cpdf_rotateBy(pagespdf7, r3, 90);
  prerr();
  cpdf_toFile(pagespdf7, "testoutputs/rotateby.pdf", false, false);
  printf("---cpdf_rotateContents()\n");
  cpdf_rotateContents(pagespdf8, r3, 35.0);
  prerr();
  cpdf_toFile(pagespdf8, "testoutputs/rotatecontents.pdf", false, false);
  printf("---cpdf_upright()\n");
  cpdf_upright(pagespdf9, r3);
  prerr();
  cpdf_toFile(pagespdf9, "testoutputs/upright.pdf", false, false);
  printf("---cpdf_hFlip()\n");
  cpdf_hFlip(pagespdf10, r3);
  prerr();
  cpdf_toFile(pagespdf10, "testoutputs/hflip.pdf", false, false);
  printf("---cpdf_vFlip()\n");
  cpdf_vFlip(pagespdf11, r3);
  prerr();
  cpdf_toFile(pagespdf11, "testoutputs/vflip.pdf", false, false);
  printf("---cpdf_crop()\n");
  cpdf_crop(pagespdf12, r3, 0.0, 0.0, 400.0, 500.0);
  prerr();
  cpdf_toFile(pagespdf12, "testoutputs/crop.pdf", false, false);
  printf("---cpdf_trimMarks()\n");
  cpdf_trimMarks(pagespdf13, r3);
  prerr();
  cpdf_toFile(pagespdf13, "testoutputs/trim_marks.pdf", false, false);
  printf("---cpdf_showBoxes()\n");
  cpdf_showBoxes(pagespdf14, r3);
  prerr();
  cpdf_toFile(pagespdf14, "testoutputs/show_boxes.pdf", false, false);
  printf("---cpdf_hardBox()\n");
  cpdf_hardBox(pagespdf15, r3, "/MediaBox");
  prerr();
  cpdf_toFile(pagespdf15, "testoutputs/hard_box.pdf", false, false);
  printf("---cpdf_removeCrop()\n");
  cpdf_removeCrop(pagespdf16, r3);
  prerr();
  cpdf_toFile(pagespdf16, "testoutputs/remove_crop.pdf", false, false);
  printf("---cpdf_removeTrim()\n");
  cpdf_removeTrim(pagespdf17, r3);
  prerr();
  cpdf_toFile(pagespdf17, "testoutputs/remove_trim.pdf", false, false);
  printf("---cpdf_removeArt()\n");
  cpdf_removeArt(pagespdf18, r3);
  prerr();
  cpdf_toFile(pagespdf18, "testoutputs/remove_art.pdf", false, false);
  printf("---cpdf_removeBleed()\n");
  cpdf_removeBleed(pagespdf19, r3);
  prerr();
  cpdf_toFile(pagespdf19, "testoutputs/remove_bleed.pdf", false, false);
  ...
  prerr();
  cpdf_toFile(misc, "testoutputs/draft.pdf", false, false);
  printf("---cpdf_removeAlltext()\n");
  cpdf_removeAllText(misc2, misc_r);
  prerr();
  cpdf_toFile(misc2, "testoutputs/removealltext.pdf", false, false);
  printf("---cpdf_blackText()\n");
  cpdf_blackText(misc3, misc_r);
  prerr();
  cpdf_toFile(misc3, "testoutputs/blacktext.pdf", false, false);
  printf("---cpdf_blackLines()\n");
  cpdf_blackLines(misc4, misc_r);
  prerr();
  cpdf_toFile(misc4, "testoutputs/blacklines.pdf", false, false);
  printf("---cpdf_blackFills()\n");
  cpdf_blackFills(misc5, misc_r);
  prerr();
  cpdf_toFile(misc5, "testoutputs/blackfills.pdf", false, false);
  printf("---cpdf_thinLines()\n");
  cpdf_thinLines(misc6, misc_r, 2.0);
  prerr();
  cpdf_toFile(misc6, "testoutputs/thinlines.pdf", false, false);
  printf("---cpdf_copyId()\n");
  cpdf_copyId(misclogo, misc7);
  prerr();
  cpdf_toFile(misc7, "testoutputs/copyid.pdf", false, false);
  printf("---cpdf_removeId()\n");
  cpdf_removeId(misc8);
  prerr();
  cpdf_toFile(misc8, "testoutputs/removeid.pdf", false, false);
  printf("---cpdf_setVersion()\n");
  cpdf_setVersion(misc9, 1);
  prerr();
  cpdf_toFile(misc9, "testoutputs/setversion.pdf", false, false);
  printf("---cpdf_setFullVersion()\n");
  cpdf_setFullVersion(misc10, 2, 0);
  prerr();
  cpdf_toFile(misc10, "testoutputs/setfullversion.pdf", false, false);
  printf("---cpdf_removeDictEntry()\n");
  cpdf_removeDictEntry(misc11, "/Producer");
  prerr();
  cpdf_toFile(misc11, "testoutputs/removedictentry.pdf", false, false);
  printf("---cpdf_removeClipping()\n");
  cpdf_removeClipping(misc12, misc_r);
  prerr();
  cpdf_toFile(misc12, "testoutputs/removeclipping.pdf", false, false);
  cpdf_deletePdf(misc);
