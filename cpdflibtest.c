...
int main(int argc, char **argv) {
  ...
  cpdf_drawBez23(0.0, 0.0, 0.0, 0.0);
  prerr();
  printf("---cpdf_drawBez13\n");
  cpdf_drawBez13(0.0, 0.0, 0.0, 0.0);
  prerr();
  printf("---cpdf_drawCircle\n");
  cpdf_drawCircle(0.0, 0.0, 0.0);
  prerr();
  printf("---cpdf_drawStrokeColGrey\n");
  cpdf_drawStrokeColGrey(0.0);
  prerr();
  printf("---cpdf_drawStrokeColRGB\n");
  cpdf_drawStrokeColRGB(0.0, 0.0, 0.0);
  prerr();
  printf("---cpdf_drawStrokeColCYMK\n");
  cpdf_drawStrokeColCYMK(0.0, 0.0, 0.0, 0.0);
  prerr();
  printf("---cpdf_drawFillColGrey\n");
  cpdf_drawFillColGrey(0.0);
  prerr();
  printf("---cpdf_drawFillColRGB\n");
  cpdf_drawFillColRGB(0.0, 0.0, 0.0);
  prerr();
